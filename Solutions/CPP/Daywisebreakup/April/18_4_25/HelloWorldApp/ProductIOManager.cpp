...
void ProductIOManager::saveProductsToFile(const std::string& filename, const std::vector<Product>& products) {
...
void ProductIOManager::displayProducts(const std::vector<Product>& products) {
...
void ProductIOManager::addProduct(std::vector<Product>& products, const Product& product) {
	products.push_back(product);
	std::cout << "Product added: " << product.getTitle() << std::endl;
}
void ProductIOManager::removeProduct(std::vector<Product>& products, int productId) {
...
void ProductIOManager::updateProduct(std::vector<Product>& products, const Product& updatedProduct) {
