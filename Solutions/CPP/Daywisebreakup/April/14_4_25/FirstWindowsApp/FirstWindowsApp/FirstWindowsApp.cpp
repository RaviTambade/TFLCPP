// FirstWindowsApp.cpp : Defines the entry point for the application.
//

#include "framework.h"
#include "FirstWindowsApp.h"
    ...
    case WM_COMMAND:
        {
            ...
            case IDM_ABOUT:
               //DialogBox(hInst, MAKEINTRESOURCE(IDD_ABOUTBOX), hWnd, About);
                MessageBox(hWnd,(LPCWSTR) "Hello Transflower",(LPCWSTR) "tfl", MB_OK);
    ...
    case WM_PAINT:
        {
            ...
            MoveToEx(hdc, 23, 23, nullptr);
            LineTo(hdc,23, 300);

            MoveToEx(hdc, 23, 23, nullptr);
            LineTo(hdc, 200, 23);

            MoveToEx(hdc, 200, 23, nullptr);
            LineTo(hdc, 200, 300);

            MoveToEx(hdc,23, 300, nullptr);
            LineTo(hdc, 200, 300);
